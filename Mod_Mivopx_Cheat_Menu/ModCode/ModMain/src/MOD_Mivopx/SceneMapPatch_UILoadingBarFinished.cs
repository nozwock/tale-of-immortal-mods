...
[HarmonyPatch(typeof(UILoadingBar), "DestroyUI")]
internal class SceneMapPatch_UILoadingBarFinished
{
	...
	private static void Postfix(UILoadingBar __instance)
	{
		...
		ModMain.Log("Loading UI Initialized.");
		if (SceneMapPatch_ConfRoleStealItem.IsStealActive)
		{
			...
			if (roleStealItem != null)
			{
				...
				roleStealItem._stealCostEnergy.value = 0;
				...
				roleStealItem._stealSucceedMin.value = 100;
				...
				roleStealItem._stealSucceedMax.value = 100;
				...
				roleStealItem._exposeReduceClosePara.value = 0;
				...
				roleStealItem._stealMoneyPercentMin.value = 35;
				...
				roleStealItem._stealMoneySpMin.value = 100;
		...
		if (roleAskfor != null)
		{
			...
			roleAskfor._costEnergy.value = 0;
		...
		if (roleConvoy != null)
		{
			...
			roleConvoy._costEnergy.value = 0;
		...
		if (roleDiscovery != null)
		{
			...
			roleDiscovery._closeAddMax.value = "100";
			...
			roleDiscovery._closeReduceMin.value = "0";
			...
			roleDiscovery._closeReduceMax.value = "0";
			...
			roleDiscovery._addExpPercent2.value = "100";
			...
			roleDiscovery._addExpPercent3.value = "100";
		...
		if (roleAttack != null)
		{
			...
			roleAttack._costEnergy.value = 0;
		...
		if (roleSchoolRecruit != null)
		{
			...
			roleSchoolRecruit._energyCost.value = 0;
		...
		if (roleTeachSkill != null)
		{
			...
			roleTeachSkill._costDay.value = 0;
